...
export default function Landing() {
  ...
  return (
    <>
      <Head>
        <title>Otuti.tk | Tiện ích như nồi</title>
        <link rel="icon" href="/favicon.ico" />
        <meta property="og:title" content="[Otuti.tk] Những tiện ích như nồi" />
      ...
      <div className="z-0	fixed w-screen h-screen top-0 left-0 bg-cover bg-shape-pattern"></div>
        ...
        <div className="container h-full m-auto flex flex-col">
          ...
          >
            <img
              ...
              src="/pot.png"
              alt="app-logo"
              className="z-10 mb-4 sm:mb-0"
            />
            <div className="z-10 ml-4 text-xl font-bold">p[Otuti]lities</div>
          ...
          >
            <div className="fade-in-bottom flow-root text-4xl font-bold text-center">
              Tôi đi code
            </div>
            <div className="fade-in-bottom-delayed flow-root text-base leading-relaxed space-y-2 text-center">
